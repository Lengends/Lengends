...
import com.wyf.lengends.util.shortcut.imp.AdwHomeBadger;
import com.wyf.lengends.util.shortcut.imp.AndroidHomeBadger;
import com.wyf.lengends.util.shortcut.imp.ApexHomeBadger;
import com.wyf.lengends.util.shortcut.imp.LGHomeBadger;
import com.wyf.lengends.util.shortcut.imp.NewHtcHomeBadger;
import com.wyf.lengends.util.shortcut.imp.NovaHomeBadger;
import com.wyf.lengends.util.shortcut.imp.SamsungHomeBadger;
import com.wyf.lengends.util.shortcut.imp.SonyHomeBadger;
...
public abstract class ShortcutBadger {
    ...
    public static void setBadge(Context context, int badgeCount) throws ShortcutBadgeException {
    	//如果当前数量和之前的数量相同，不进行AppIcon的操作
//    	if(!PreferenceUtil.getInstance(XinWoApplication.getInstance()).isAppIconShowMsgNum(badgeCount)){
//    		return;
//    	}
