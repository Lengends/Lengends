...
import com.org.lengend.pagedview.demo.PagedViewActivity;
import com.org.lengend.photoview.PhotoActivity;
import com.org.lengend.recycleview.HorizontalRecycleViewActivity;
import com.org.lengend.recycleview.RecycleViewActivity;
...
//        data.add(photoView);
        ...
        MainDataEntity pagedViewActivity = new MainDataEntity();
        pagedViewActivity.setTitle("PagedViewActivity");
        pagedViewActivity.setDesc("PagedViewActivity");
        pagedViewActivity.setGoClass(PagedViewActivity.class);
        data.add(pagedViewActivity);


        MainDataEntity horizontalRecycleViewActivity = new MainDataEntity();
        horizontalRecycleViewActivity.setTitle("HorizontalRecycleViewActivity");
        horizontalRecycleViewActivity.setDesc("HorizontalRecycleViewActivity");
        horizontalRecycleViewActivity.setGoClass(HorizontalRecycleViewActivity.class);
        data.add(horizontalRecycleViewActivity);


        MainDataEntity recycleViewActivity = new MainDataEntity();
        recycleViewActivity.setTitle("RecycleViewActivity");
        recycleViewActivity.setDesc("RecycleViewActivity");
        recycleViewActivity.setGoClass(RecycleViewActivity.class);
        data.add(recycleViewActivity);
